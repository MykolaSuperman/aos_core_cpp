...
private:
    ...
    // Batch teardown: when active, StopInstanceMonitoring appends its deletes
    // here (serialized by mBatchTxnMutex) instead of committing, and FlushBatch
    // commits the lot in one nft transaction.
