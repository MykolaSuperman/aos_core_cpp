...
#include <common/utils/genericsubscriptionmanager.hpp>
...
using NodeInfoSubscriptionManager = utils::GenericSubscriptionManager<iamanager::v6::IAMPublicCurrentNodeService::Stub,
